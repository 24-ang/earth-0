...
export class InteractiveMode {
    ...
    constructor(runtimeHost, options = {}) {
        ...
        console.log("[FORK] gamePanelContainer added to InteractiveMode constructor");
        this.gamePanelContainer = new Container();
        this.gamePanel = null;
    ...
    async init() {
        ...
        this.ui.addChild(this.gamePanelContainer);
    ...
    /**
     * Set a game panel component (earth-0 fork: gamePanelContainer).
     */
    setGamePanel(factory) {
        this.gamePanelContainer.clear();
        if (!factory) {
            this.ui.requestRender();
            return;
        }
        const component = factory(this.ui, theme);
        this.gamePanel = component;
        this.gamePanelContainer.addChild(component);
        this.ui.requestRender();
    }
    ...
    renderWidgets() {
        ...
        // earth-0 fork: register above-editor widget for arrow key interception
        let handler = null;
        for (const w of this.extensionWidgetsAbove.values()) {
            if (w.handleInput) { handler = (d, focused) => { return w.handleInput(d, focused); }; break; }
        }
        this.ui.setAboveEditorInputHandler(handler);
        this.ui.requestRender();
    }
    ...
    createExtensionUIContext() {
        return {
            ...
            setGamePanel: (factory) => this.setGamePanel(factory),
