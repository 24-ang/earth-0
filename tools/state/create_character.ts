...
export default {
    ...
    parameters: Type.Object({
      ...
      appearance_brief: Type.Optional(Type.String({ description: "外貌简述——叙事LLM据此写角色出场画面。如'金发双马尾，总戴着红色发卡，校服穿得松松垮垮'。缺少则角色在叙事中无外貌锚点" })),
      ...
      outfits: Type.Optional(Type.Record(Type.String(), Type.Record(Type.String(), Type.String()), { description: "多套服装卡，值用具体物品名（引擎据此查flavor）: {school:{top:'总武高女生制服',bottom:'总武高制服裙'},casual:{top:'长袖衬衫',bottom:'休闲裤'},pe:{top:'体操服',bottom:'运动短裤'},swim:{top:'比基尼'},sleep:{top:'睡裙'}}" })),
